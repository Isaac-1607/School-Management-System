    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="menu">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="/instituto_heroes_U3/examenes/consultar_es.php">Consultar</a></li>
  ...
  <main class="container" style="margin-top:100px;">
    <div class="card shadow-lg border-0">
      <div class="card-body text-center">
        <h2 class="mb-3">Bienvenido/a <?php echo htmlspecialchars($_SESSION['nombre'] . ' ' . $_SESSION['apellido_paterno'] . ' ' . $_SESSION['apellido_materno']); ?></h2>
        <p class="lead">Has ingresado como <strong>Estudiante</strong>.</p>
      </div>
    </div>
  </main>
